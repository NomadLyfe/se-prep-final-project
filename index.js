...
let p2 = "The inventor of modern sushi is believed to be Hanaya Yohei, who invented nigiri-zushi, a type of sushi most known today, in which seafood is placed on hand-pressed vinegared rice, around 1824 in the Edo period (1603 – 1867). It was the fast food of the chōnin class in the Edo period."
...
let p41 = "When making fukusazushi, a paper-thin omelette may replace a sheet of nori as the wrapping. The omelette is traditionally made on a rectangular omelette pan, known as a makiyakinabe, and used to form the pouch for the rice and fillings."
let h13 = "<h2>Gu</h2>"
...
let p44 = "Pickled daikon radish (takuan) in shinko maki, pickled vegetables (tsukemono), fermented soybeans (nattō) in nattō maki, avocado, cucumber in kappa maki, asparagus, yam, pickled ume (umeboshi), gourd (kanpyō), burdock (gobo), and sweet corn (sometimes mixed with mayonnaise) are plant products used in sushi."
...
let p46 = "Sushi is commonly eaten with condiments. Sushi may be dipped in shōyu (soy sauce), and is usually flavored with wasabi, a piquant paste made from the grated stem of the Wasabia japonica plant. Japanese-style mayonnaise is a common condiment in Japan on salmon, pork, and other sushi cuts."
...
let p53 = "Large marine apex predators such as tuna (especially bluefin) can harbor high levels of methylmercury, one of many toxins of marine pollution. Frequent or significantly large consumption of methylmercury can lead to developmental defects when consumed by certain higher-risk groups, including women who are pregnant or may become pregnant, nursing mothers, and young children.[87] A 2021 study in Catalonia, Spain reported that the estimated exposure to methylmercury in sushi consumption by adolescents exceeded the tolerable daily intake."
let p54 = "A 2011 article reported approximately 18 million people infected with fish-borne flukes worldwide. Such an infection can be dangerous for expecting mothers due to the health risks that medical interventions or treatment measures may pose on the developing fetus. Parasitic infections can have a wide range of health impacts, including bowel obstruction, anemia, liver disease, and more.[89] These illnesses' impact can pose health concerns for the expecting mother and baby."
